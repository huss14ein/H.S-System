...
const AIExecutiveSummary: React.FC = () => {
    ...
    useEffect(() => {
        if (!isAiAvailable || isLoading || summary || error || hasAutoGenerated) return;
        setHasAutoGenerated(true);
        handleGenerate();
    }, [isAiAvailable, isLoading, summary, error, hasAutoGenerated, handleGenerate]);
        ...
        <div className="section-card border-t-4 border-secondary">
            ...
            {!summary && !isLoading && !error && (
                <div className="text-center p-8 text-gray-500">
                    Preparing your concise executive summary...
