...
export const PAGE_MODULES: Record<Page, PageModule | undefined> = {
  ...
  Rewards: lazyPage(() => import('../pages/Rewards')),
  Documents: lazyPage(() => import('../pages/Documents')),
  Subscriptions: lazyPage(() => import('../pages/Subscriptions')),
  Estate: lazyPage(() => import('../pages/Estate')),
