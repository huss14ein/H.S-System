...
export function overlayLiveQuoteTierOntoExtendedMetrics(
  ...
  return {
    ...
    availableLiquiditySar: live.availableLiquiditySar,
    reservedLiquiditySar: live.reservedLiquiditySar,
    emergencyFundFloorSar: live.emergencyFundFloorSar,
    rewardsSar: live.rewardsSar,
