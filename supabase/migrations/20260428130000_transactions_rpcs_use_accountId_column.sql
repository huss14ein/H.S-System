-- Schemas that only have quoted camelCase "accountId" on public.transactions (no account_id)
-- fail RPC inserts that list account_id. Use "accountId" in INSERT column lists.
...
begin
  ...
  insert into public.transactions (
    user_id, date, description, amount, type, "accountId", category, transfer_group_id, transfer_role
  )
  values (
    v_user_id,
    p_date,
