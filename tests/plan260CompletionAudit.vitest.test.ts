 ...
 * Current packaged app version is asserted as 3.1.0.0.
 */
...
describe('plan 2.6 feature completion audit', () => {
  it('version 3.1.0.0 in package and buildInfo', () => {
    expect(read('package.json')).toContain('"version": "3.1.0.0"');
    expect(read('utils/buildInfo.ts')).toContain("APP_VERSION = '3.1.0.0'");
  });
