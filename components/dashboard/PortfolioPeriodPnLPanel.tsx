...
export const PortfolioPeriodPnLPanel: React.FC<{
  ...
  return (
    <div dir={dir} className="rounded-2xl border border-indigo-100 bg-gradient-to-br from-indigo-50/40 via-white to-slate-50 shadow-sm overflow-hidden">
      <div className="px-4 py-4 sm:px-5 border-b border-indigo-100/80 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
      ...
      {setActivePage && (
        <div className="px-4 py-3 border-t border-slate-100 bg-white/60 text-end">
          <button
            type="button"
